...
Andrew Zisserman\cite{vggpaper}. W publikacji zaprezentowano kilka wariantów tej sieci. Ja z uwagi na większą ilość warstw użyję wariantu VGG-19, którego schemat znajduje się na rysunku \ref{fig:vgg19-schemat}.
...
Weźmy przykładowo klasę numer 319 w przypadku tego konkretnego modelu odpowiada ona klasie ważki. Przykładowego przedstawiciela tej klasy przedstawia rysunek \ref{lst:wazka-prediction-result}.
