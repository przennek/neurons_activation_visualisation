...
Przy założeniu, że rozmiar liczby typu double to 64 bity, to sama taka pojedyncza macierz miałaby rozmiar \(64\ \left\lbrack b \right\rbrack \times 30000 \times 15000 \times \frac{1}{8\ }\ \times \frac{1}{1024\ } \frac{1}{1024\ }\  \approx \ 3433\ \lbrack MB\rbrack\). Poza problemami z pamięcią,
...
\begin{figure}[ht]
\centerline{\includegraphics[scale=1]{resources/cnn/lenet5.pdf}}
